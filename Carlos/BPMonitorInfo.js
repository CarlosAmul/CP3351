...
export default function BPMonitorInfo({ user, category, sensor }) {
    ...
    return (
        <View>
            ...
            <Text
                ...
                darkColor="rgba(255,255,255,0.8)"
            >
                Max DIA: {sensor.maxDia}
            </Text>
            <Text
                style={styles.getStartedText}
                lightColor="rgba(0,0,0,0.8)"
                darkColor="rgba(255,255,255,0.8)">
                Min SYS: {sensor.minSys}
            </Text>
            <Text
                style={styles.getStartedText}
                lightColor="rgba(0,0,0,0.8)"
                darkColor="rgba(255,255,255,0.8)">
                Min DIA: {sensor.minDia}
            </Text>
            {
                reading
                &&
                <View>
                    <Text
                        ...
                        lightColor="rgba(0,0,0,0.8)"
                        darkColor="rgba(255,255,255,0.8)">
                        SYS/DIA: {reading.current.sys}/{reading.current.dia}
                    </Text>
                    <Text
                        style={sensor.alert ? styles.getStartedRed : styles.getStartedGreen}
                        lightColor="rgba(0,0,0,0.8)"
                        darkColor="rgba(255,255,255,0.8)">
                        Pulse: {reading.current.pulse} BPM
                    </Text>
                </View>
